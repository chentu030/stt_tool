...
import { STICKY_COLORS, colorToShapeHex, resolveStickyStyle } from "@/lib/canvasStore";
...
export default function CanvasColorPicker({ color, onChange, open, onClose, anchorRef }: Props) {
